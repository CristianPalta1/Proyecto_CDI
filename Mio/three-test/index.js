...
//         ratio = width / height;
// var texture = THREE.ImageUtils.loadTexture('https://dev-enel-expedicion-e.ariadna.co/sites/default/files/2023-02/test.jpg', new THREE.UVMapping(), function() {
//     init();
//     animate();
...
function procesarArray(array) {
  ...
  console.log(procesarArray(miArray));  // Resultado: "1234"